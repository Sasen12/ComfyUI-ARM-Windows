...
def get_connection_feature(
    ...
    feature_flags = sockets_metadata[sid].get("feature_flags", {})
...
def get_server_features() -> dict[str, Any]:
    ...
    """
    # Return a deep copy so callers cannot mutate nested defaults in-place.
    return deepcopy(SERVER_FEATURE_FLAGS)
